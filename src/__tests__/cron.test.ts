...
vi.mock('../services/whatsapp.service', () => ({ default: () => null }));
vi.mock('../services/invoiceNotification.service', () => ({
    default: {
...
import { cronJobConfigs, cronSchedules } from '../config/cron.config';
...
describe('CronService.executeJob', () => {
    ...
    const loadService = async () => {
        vi.resetModules();
        const mod = await import('../services/cron.service');
        return mod.default;
    };
